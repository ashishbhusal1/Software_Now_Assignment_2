...
from typing import (
    List,
    Tuple,
)  # I use this just to describe the types like lists and strings
...
def encrypt_file(
    in_path: str, out_path: str, shift1: int, shift2: int
) -> Tuple[str, List[int]]:
    ...
    ) as fe:  # Saving the encrypted string into a file
...
def decrypt_file(
    in_path: str, out_path: str, rules: List[int], shift1: int, shift2: int
) -> str:
    ...
    decrypted_text = "".join(
        decrypted_chars
    )  # Joining the decrypted characters into a string
